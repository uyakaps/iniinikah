...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `⁨tkecard@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://youtube.com/channel/UCWypTAqhYCI45waiZg9T3Lg`, `nothing`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://youtube.com/channel/UCWypTAqhYCI45waiZg9T3Lg`, `🤖 Dont Forget To Donate!`]
  ], fkontak)
